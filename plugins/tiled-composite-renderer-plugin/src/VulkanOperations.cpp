...
void utils::createBuffer(VkDevice &device, VkPhysicalDevice &physicalDevice,
...
void utils::createImage(VkImage &image, VkDeviceMemory &imageMemory,
...
void utils::transitionImageLayout(VkImage image, VkFormat format,
                                  ...
                                  VkImageLayout newLayout, VkDevice &device,
  ...
  vkCmdPipelineBarrier(commandBuffer, 0 /* TODO */, 0 /* TODO */, 0, 0, nullptr,
                       0, nullptr, 1, &barrier);
...
void utils::copyBufferToImage(VkBuffer &buffer, VkImage &image,
  ...
  auto command_buffer = beginSingleTimeCommands(device, pool);
  ...
  endSingleTimeCommands(command_buffer, device, pool, queue);
};
